...
它把新品上市拆成 **Five Launch Gates** 和 **Three Launch Packages**，让 AI Agent 能基于零散的产品信息、市场信息或业务文档，快速产出可执行的 GTM 操盘材料：上市计划、上市准备度检查、关键物料清单、竞品定位、渠道打法、风险清单、责任人分工、首轮价格调整逻辑和上市后复盘优化方案。

This is a practical Codex skill for go-to-market work. It helps teams turn incomplete product and market information into execution-ready launch plans, readiness reviews, launch asset checklists, competitive positioning, pricing adjustment logic, and post-launch optimization plans.
...
```text
Use Five Launch Gates And Three Packages to create a GTM launch plan for [产品] in [市场].
```
...
```text
请基于 Five Launch Gates And Three Packages，推演新品上市后的首轮调价策略。
```
